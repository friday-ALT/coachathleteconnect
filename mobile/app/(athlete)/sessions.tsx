...
export default function Sessions() {
  ...
  const renderConfirmedCard = (r: any) => (
    <GlossCard key={r.id} padding={0} style={styles.sessionCard}>
  ...
  const renderDeclinedCard = (r: any) => (
    <GlossCard key={r.id} padding={0} style={[styles.sessionCard, styles.declinedRow]}>
      <View style={styles.sessionRow}>
...
const styles = StyleSheet.create({
  ...
  emptySub: { fontSize: FontSizes.sm, color: Colors.body, textAlign: 'center' },
